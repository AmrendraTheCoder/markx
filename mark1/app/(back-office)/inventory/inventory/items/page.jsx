  ...
  return (
    <div>
      ...
      <div className="px-4 py-8 gap-3 rounded border border-slate-200 shadow-md bg-white flex flex-col justify-center items-center">
        <h2 className="font-semibold text-xl">Item Groups</h2>
        <div className="w-36 h-36">
          {/* <Shirt className="w-36 h-36" /> */}
          <svg
      ...
      <div className="px-4 py-8 gap-3 rounded shadow-md border border-slate-200 bg-white flex flex-col justify-center items-center">
        ...
        <Link
          href=""
          className="flex justify-center text-sm items-center px-3 py-2 gap-1 font-semibold bg-blue-500 rounded-md text-white"
        >
          New Item
        </Link>
        {/* <button className="flex justify-center items-center px-3 py-2 gap-1 bg-blue-500 rounded-md text-white">
      ...
      <div className="px-4 py-8 gap-3 rounded shadow-md border border-slate-200 bg-white flex flex-col justify-center items-center">
        <h2 className="font-semibold text-xl">Composite Items</h2>
        <div className="w-36 h-36">
          {/* <Shirt className="w-36 h-36" /> */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="px-4 py-8 gap-3 rounded border border-slate-200 shadow-md bg-white flex flex-col justify-center items-center">
        <h2 className="font-semibold text-xl">Price Lists</h2>
        <div className="w-36 h-36">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
